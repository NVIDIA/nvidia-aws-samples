...
output "eks_release_names" {
  description = "Map of deployment key to Helm release name."
...
output "model_profile_cache_uris" {
  description = "S3 URIs for pre-cached NIM model profiles. Shows where the cache was written after apply."
